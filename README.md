...
eksctl create cluster --name kubernetes-cluster --version 1.35 --region us-east-2 --nodegroup-name linux-nodes --node-type t2.xlarge --nodes 2

#To Delete EKS cluster
eksctl delete cluster --region=us-east-2 --name=kubernetes-cluster #delete eks cluster
```

## Step 5: Cleanup Terraform Resources
